      ...
      <div className="w-full border border-white rounded-xl p-6 max-w-lg mx-auto">
        ...
        <div className="py-6 flex gap-4 flex-col">
          <p className="max-w-[60ch] text-justify mx-auto text-sm">
            Pulsando en "CREAR" aceptas que tu imagen sea utilizada para fines no comerciales, siendo publicadas en esta web y visible por cualquier
            persona que acceda a la misma.
          </p>
          <p className="max-w-[60ch] text-justify mx-auto text-sm">
        ...
        <div className="flex items-center justify-center mt-6">
          <button className="bg-white rounded-lg py-2 px-4 text-xl text-black font-bold" onClick={handleAccept}>
            Aceptar y crear
          </button>
        </div>
      </div>
